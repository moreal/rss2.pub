...
import type { Rss2ParseError, Rss2ParserLimits } from "./model.js";
...
class ParseAbort extends Error {
  public constructor(public readonly parseError: Rss2ParseError) {
    super(parseError.type);
  }
}

export function parseXml(xml: string, limits: Rss2ParserLimits): XmlParseResult {
